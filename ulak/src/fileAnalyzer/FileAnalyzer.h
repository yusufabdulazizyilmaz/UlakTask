...
public:
    ...
    [[nodiscard]] const std::string& getLibrary() const;

    [[nodiscard]] const std::vector<std::filesystem::path>& getTxtFileVec() const;

private:
    [[nodiscard]] std::vector<std::filesystem::path> fileAnalizer();
